import {Parallax, ParallaxLayer} from '@react-spring/parallax.js';
import { useRef, useEffect } from 'react.js';
import { render } from 'react-dom.js';
import Plyr from 'plyr-react.js'
      ...
      <Parallax pages={1.9} ref={ref} style={{ top: '0', left: '0' }}>
        ...
        <ParallaxLayer
          ...
          <div style={carddivstyle}>
            <img src='/src/cards/plus_four.png' style={cardstyle}></img><img src='/src/cards/green_nine.png' style={cardstyle}></img>
          </div>
        </ParallaxLayer>
        <ParallaxLayer
          offset={0.35}
          speed={1.15}>
          <div style={carddivstyle}>
            <img src='/src/cards/red_reverse.png' style={cardstyle}></img><img src='/src/cards/green_two.png' style={cardstyle}></img>
          </div>
        </ParallaxLayer>
        <ParallaxLayer
          offset={0.45}
          speed={1.25}>
          <div style={carddivstyle}>
            <img src='/src/cards/yellow_plus_two.png' style={cardstyle}></img><img src='/src/cards/choose_color.png' style={cardstyle}></img>
          </div>
        </ParallaxLayer>
        <ParallaxLayer
          offset={0.55}
          speed={1.35}>
          <div style={carddivstyle}>
            <img src='/src/cards/blue_four.png' style={cardstyle}></img><img src='/src/cards/red_eight.png' style={cardstyle}></img>
          </div>
        </ParallaxLayer>
        <ParallaxLayer
          offset={0.15}
          speed={1.25}>
          <div style={{'textAlign': 'center', 'fontSize': 'max(7vw, 70px)', 'min-width': '10vw', 'fontWeight': 'bold'}}><p style={{'color': 'red', 'display': 'inline'}}>U</p>
            ...
            <br></br>
            <div style={{'textAlign': 'center', 'width': '40vw', 'min-width': '200px', 'marginLeft': 'auto', 'marginRight': 'auto'}}>
        ...
        <ParallaxLayer
          offset={0.90}
          speed={1}>
          <div style={{'width': '50%', 'min-width': '380px', 'justifyContent': 'center', 'marginLeft': 'auto', 'marginRight': 'auto', 'display': 'block', 'marginTop': '15px', 'marginBottom': '200px'}}>
            <Plyr src='/src/static/mock_trailer.mp4' width="350"></Plyr>
          </div>
        </ParallaxLayer>
        <ParallaxLayer
          ...
          <div style={{'marginTop': '200px', 'background': 'linear-gradient(0deg, #36676e 30%, #B0E0E6 100%)'}}>
            ...
            <div style={textcarddivstyle}>
              <div style={{'display': 'inline-grid'}}>
                <img src='/src/cards/blue_x_ray.png' className='textcardstyle'></img>
                <div className='carddescription'>
                  <p style={{'fontSize': 'max(2vw, 18px)', 'fontWeight': 'bold'}}>The X-Ray Card</p><br></br>
                </div>
              </div>
              <div style={{'display': 'inline-grid'}}>
                <img src='/src/cards/red_plus_two_all.png' className='textcardstyle'></img>
                <div className='carddescription'>
          ...
          <div style={{'background': '#36676e', 'paddingTop': '100px'}}>
            <button style={{'justifyContent': 'center', 'marginLeft': 'auto', 'marginRight': 'auto', 'display': 'block', 'width': '28vw', 'min-width': '350px', 'inlineSize': 'min-content'}} className='button-19' onClick={() => window.location.href = "https://git.scicore.unibas.ch/cs108-fs22/Gruppe-1"}>
